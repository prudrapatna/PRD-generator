...
The essential connection between these two is the Monthly Wellness Roll-up. By letting users know how frequently in a month was their breathing optimal in a calendar month, we transition the conversation from "one bad night" to "a persistent trend." This prepares the user for the 4-month clinical check-in, making the SaMD result feel like a logical conclusion based on their own observed data.
...
* **Awareness (The Roll-up):** The glanceable view of frequency of days with optimal breathing > 94.3% validates the user's lived experience (e.g., "I have been feeling tired").
...
| --- | --- | --- | --- |
| **Trigger** | Every morning after sleep. | Once per month (frequency of % of nights with optimal breathing > 94.3%).<br><br>- Most nights<br>- Some nights<br>- Very few nights | Initial Opt-in, User-initiated via Roll-up, or 4-month recurrence. |
