...
*   **Deliverable:** Product Proposal (Mini PRD / Product Story)
...
<table style="border: 1.5pt solid black; width: 100%; border-collapse: collapse;">
  <tr>
    <td style="padding: 20px;">
      ...
      <p><strong>August 16th, 2026:</strong> For millions of people, waking up exhausted despite getting enough hours of sleep is a frustrating mystery. Often, the culprit is invisible: subtle, persistent fluctuations in breathing during the night that disrupt restorative sleep. Because we are asleep when this happens, these patterns go unnoticed, leaving people without the awareness needed to improve their rest and daytime energy.</p>
      ...
      <p>Sleep Breathing Quality is designed to start conversations and inspire healthier habits, not replace professional care. It provides thoughtful, personalized insights to help you manage your wellness, and if patterns persist, seamlessly guides you toward a clinical assessment when appropriate. In a world of constant alerts, Google is taking a quieter approach: one thoughtful insight a month.</p>
    </td>
  </tr>
</table>
...
## Target Product Profile (The Master Grid)

| Category | Definition |
| :--- | :--- |
| **Intended Use Statement** | A software-only general wellness feature intended for informational and educational purposes only. It tracks nightly breathing patterns as an indicator of sleep quality, estimating the percentage of time spent in 'Optimal Breathing' to empower lifestyle choices. Not intended to diagnose, treat, cure, or prevent any disease or condition. |
...
| **Feature Prioritization** | • **[P0]** Daily % of optimal breathing score.<br>• **[P0]** Monthly roll-up (frequency of optimal breathing).<br>• **[P0.5]** Ability to ask questions in Ask Health.<br>• **[P1]** Contextual nudge for persistent trends. |
...
| **Algorithm Output** | Predictive probability ranging from 0 to 1 of sleep disordered breathing per 1-minute epoch, translated into a categorical output: Optimal, Limited, Considerable, or Significant periods of strained breathing. |
| **Product Type** | Passive, Continuous and Recurring Assessment. |
| **Assessment Period** | **Evaluation Window:** Rolling calendar month.<br>**Data Sufficiency:** Minimum of 7 valid days (≥8 hours wear time) with 7 sleep sessions.<br>**Threshold Logic:** Aggregated minutes to determine % of night with BQM > 0.25. |
...
| **Algorithm Inputs / Product Inputs** | Valid PPG and accelerometer sensor data during the main sleep period. |
...
## Market Positioning: The Personal Health Assistant (9 Things)
...
## Feature Logic Definitions & Algorithm Performance
...
| **Tier 2** | ≥ 83% to < 94.3% | Good / Limited |
| **Tier 3** | ≥ 66% to < 83% | Moderate / Considerable |
| **Tier 4** | < 66% | Low / Significant |
...
## Appendix
*   **Consumer Interest:** While specific conjoint WTP values for breathing alone are part of the broader sleep proposition, features resolving daytime fatigue without requiring a clinical setup are central to the Personal Health Assistant's value. 
...
*   **EU Regulatory (MDR):** Targeted at healthy individuals only, explicitly avoiding clinical diagnostic terms like "mild/moderate/severe apnea" in the general wellness interface, focusing instead on "amount of sleep impacted" (e.g., Optimal, Limited, Considerable, Significant).